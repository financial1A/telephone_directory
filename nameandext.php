<?php
	...
	<input name="ref4" id="ref4" placeholder="Name" oninput="this.value=this.value.toUpperCase();">
...
<input name="ref6" id="ref6" placeholder="Mobile" oninput="this.value=this.value.toUpperCase();">
	<button  onclick="upnameext()" value="Update" style="border-radius:5px;color:white;font-size:15px;background-color:#0099ff;border-color:white;">Update</button>';
	}else{
	 echo 'PLEASE LOGIN';
	}
