...
<h2 style="color: #3498db; padding: 20px; margin: 20px; text-align: center; border: 2px solid #3498db; border-radius: 10px; box-shadow: 5px 10px #888888;">
  Add New Record 
</h2>
<form action="newrecord2.php" method="post">
  <table>
    <tr>
      <td>Name:</td>
      <td><input type="text" name="name" id="search" oninput="this.value=this.value.toUpperCase()"></td>
    </tr>
    <tr>
      <td>EXT:</td>
    ...
    <tr>
      <td>Dept:</td>
      <td><input type="text" name="company" oninput="this.value=this.value.toUpperCase()"></td>
    </tr>
 <tr>
      <td>Location:</td>
      <td><input type="text" name="location" oninput="this.value=this.value.toUpperCase()"></td>
    </tr>
    <tr>
      <td colspan="2"><input type="submit" value="New Record" style="background-color:rgb(255,255,0,0.4);border-radius:5px;"></td>
    </tr>
  </table>
</form>
...
<script>
    ...
    searchBox.addEventListener('input', function() {
        ...
        xhr.open('GET', '3.php?q=' + encodeURIComponent(searchBox.value), true);
