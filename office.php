...
<a href="newrecord.php" ><button >NEW RECORD</button></a>
<a href="view.php" ><button >ADVANED SEARCH</button></a>
...
<script>
    ...
    // Add custom headers
    var customHeaders = ['NAME', 'EXT','MOBILE','DEP','LOCATION']; // replace with your headers
